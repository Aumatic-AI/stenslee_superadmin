...
import { emptyFeatureGrid } from "@/lib/feature-grid";
...
export default function NewPlanPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <PageHeader title="New Plan" description="Define pricing and default feature access." />

      <Card className="p-5 flex flex-col gap-4">
        <div className="grid sm:grid-cols-2 gap-4">
          <Input label="Plan Name" value={name} onChange={(e) => setName(e.target.value)} placeholder="e.g. Growth" />
          <Input
            label="Price (USD)"
            type="number"
            min={0}
        ...
        <Input
          ...
          placeholder="One line shown to your team when choosing a plan."
        />
